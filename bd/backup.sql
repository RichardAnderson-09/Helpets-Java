...
--
-- Host: localhost    Database: helpets_database
-- ------------------------------------------------------
...
CREATE TABLE `adopciones` (
  ...
  `estado_solicitud` char(1) NOT NULL DEFAULT 'P',
  `comentarios` text,
...
INSERT INTO `adopciones` VALUES (1,4,6,1,'2026-06-15 00:00:00',NULL,'R','Todo bien\r\nNo paso'),(2,5,3,1,'2026-06-15 00:00:00',NULL,'A','limpio');
...
INSERT INTO `compras` VALUES (1,1,'2026-06-15 23:55:55','Compra mensual de alimentos'),(2,1,'2026-06-15 23:55:55','Compra de medicinas de urgencia'),(3,2,'2026-06-15 23:55:55','Útiles de limpieza para caniles'),(4,1,'2026-06-15 23:55:55','Juguetes y accesorios'),(5,2,'2026-06-15 23:55:55','Compra adicional RicoCat por escasez');
...
INSERT INTO `detalle_compra` VALUES (6,1,1,10,150.00),(7,2,3,20,15.50),(8,3,4,5,25.00),(9,4,5,10,12.00),(10,5,2,10,45.00);
...
INSERT INTO `detalle_donacion` VALUES (6,1,NULL,NULL,500.00),(7,2,2,5,NULL),(8,3,NULL,NULL,200.00),(9,4,5,10,NULL),(10,5,NULL,NULL,150.00),(11,6,3,5,NULL),(12,7,NULL,NULL,20.00),(13,8,NULL,NULL,50.00);
...
CREATE TABLE `donaciones` (
  ...
  `tipodonacion` varchar(9) NOT NULL,
...
INSERT INTO `donaciones` VALUES (1,1,3,'2026-06-15 23:57:11','MONETARIA'),(2,2,4,'2026-06-15 23:57:11','MATERIAL'),(3,1,5,'2026-06-15 23:57:11','MONETARIA'),(4,2,3,'2026-06-15 23:57:11','MATERIAL'),(5,1,4,'2026-06-15 23:57:11','MONETARIA'),(6,1,6,'2026-06-15 00:00:00','MATERIAL'),(7,2,2,'2026-06-26 02:24:09','MONETARIA'),(8,1,1,'2026-06-26 02:30:24','MONETARIA');
...
CREATE TABLE `especies` (
  ...
  UNIQUE KEY `uk_especies_esp` (`nombre_especie`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `historialmedicos`
--

DROP TABLE IF EXISTS `historialmedicos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `historialmedicos`
--

LOCK TABLES `historialmedicos` WRITE;
/*!40000 ALTER TABLE `historialmedicos` DISABLE KEYS */;
INSERT INTO `historialmedicos` VALUES (1,4,3,'Proceso correcto','2026-06-17 06:18:00',15.00);
/*!40000 ALTER TABLE `historialmedicos` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `historialvol`
--

LOCK TABLES `historialvol` WRITE;
/*!40000 ALTER TABLE `historialvol` DISABLE KEYS */;
INSERT INTO `historialvol` VALUES (1,8,'2026-06-16',NULL,'A');
/*!40000 ALTER TABLE `historialvol` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `mascotas` VALUES (2,4,'Lunaa','2026-05-15','1','default.jpg','S','H'),(3,2,'Pipo','2026-06-01','1','default.jpg','S','H'),(4,2,'Oso','2026-06-05','1','perro.jpg','S','M'),(5,3,'Pipo 2','2026-06-09','0','default.jpg','S','H');
...
INSERT INTO `movimientos_inventario` VALUES (6,1,1,'E',20,'2026-06-25 03:02:17'),(7,2,2,'E',15,'2026-06-25 03:02:17'),(8,1,1,'S',5,'2026-06-25 03:02:17'),(9,3,2,'E',50,'2026-06-25 03:02:17'),(10,4,1,'S',2,'2026-06-25 03:02:17'),(11,6,1,'E',10,'2026-06-25 03:59:36'),(12,6,1,'S',2,'2026-06-25 04:00:49');
...
INSERT INTO `personas` VALUES (1,'Andrea','Cuba','1995-08-15','DNI','70123456','987654321','andrea.yh@helpets.com',1,NULL,'110101'),(2,'Brenda','Francia','1996-05-20','DNI','70654321','912345678','brenda.f@helpets.com',1,NULL,'110101'),(3,'Juan','Perez','1994-11-10','DNI','70987654','998877665','juan.p@helpets.com',1,NULL,'110101'),(4,'Carlos','Mendoza','1985-03-25','DNI','40123456','944556677','carlos.m@helpets.com',1,NULL,'110101'),(5,'Ana','Gomez','1998-07-30','DNI','70223344','933445566','ana.g@helpets.com',1,NULL,'110101'),(6,'Roberto','Nuñez',NULL,'DNI','1234567','961118837','roberto@gmail.com',1,NULL,'110101'),(7,'Miguel','Choque','1999-11-10','DNI','81726354','998877665','miguel@helpets.com',1,NULL,'010101'),(8,'prueba','test','2026-06-10','DNI','85451614','961118837','miguel@helpets.com',1,NULL,'010101');
...
CREATE TABLE `procesosmedicos` (
  `idprocesomedico` int NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `procesosmedicos`
--

LOCK TABLES `procesosmedicos` WRITE;
/*!40000 ALTER TABLE `procesosmedicos` DISABLE KEYS */;
INSERT INTO `procesosmedicos` VALUES (1,'Vacunación Antirrábica','Vacuna anual obligatoria contra la rabia'),(2,'Desparasitación Interna','Eliminación de parásitos gastrointestinales'),(3,'Esterilización','Cirugía de esterilización o castración'),(4,'Tratamiento Antidermatitis','Tratamiento para afecciones de la piel'),(5,'Revisión General','Chequeo médico de rutina');
/*!40000 ALTER TABLE `procesosmedicos` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `productos` VALUES (1,'RicoCan Adulto 15kg','Alimento seco para perros adultos','Alimento',50),(2,'RicoCat 1kg','Alimento seco para gatos','Alimento',30),(3,'Pipeta Antipulgas','Medicamento contra pulgas y garrapatas','Medicamento',105),(4,'Champú para perros','Limpieza y cuidado del pelaje','Material',20),(5,'Juguete hueso goma','Juguete masticable antiestrés','Material',40),(6,'Ricocan Cachorros 3Kg','','Alimento',8);
...
CREATE TABLE `razas` (
  ...
  PRIMARY KEY (`idraza`),
  UNIQUE KEY `uk_raza_raz` (`idespecie`,`nombre_raza`),
...
INSERT INTO `razas` VALUES (2,'Labrador',1),(1,'Mestizo',1),(3,'Mestizo',2),(4,'Siamés',2);
...
INSERT INTO `roles` VALUES (1,'Administrador'),(4,'Usuario'),(3,'Veterinario'),(2,'Voluntario');
...
INSERT INTO `usuarios` VALUES (1,1,1,'acuba','8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92','2026-06-15 21:46:03','A',NULL),(2,2,4,'bfrancia','8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92','2026-06-15 21:46:03','A',NULL),(3,3,1,'jperez','8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92','2026-06-15 21:46:03','A',NULL),(4,4,3,'cmendoza','8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92','2026-06-15 21:46:03','A',NULL),(5,5,2,'agomez','8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92','2026-06-15 21:46:03','A',NULL),(6,7,3,'miguel','8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92','2026-06-17 02:03:36','A',NULL),(8,8,2,'test','8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92','2026-06-17 02:38:54','A',NULL);
...
-- Dump completed on 2026-07-08  1:15:48
